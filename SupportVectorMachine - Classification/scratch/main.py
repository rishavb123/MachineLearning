...
class SupportVectorMachine:
    ...
    def fit(self, data):
        ...
        for step in step_sizes:
            ...
            while not optimized:
                for b in np.arange(-self.max_feature_value*b_range_multiple, self.max_feature_value*b_range_multiple, b_multiple * step):
            ...
            opt_choice = opt_dict[magnitudes[0]]
    ...
    def visualize(self):
        ...
        # (x.w+b) = 0
        # seperating hyperplane / decision boundry
...
[svm.predict(p) for p in predict_us]
